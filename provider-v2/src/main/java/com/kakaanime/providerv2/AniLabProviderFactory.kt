...
object AniLabProviderFactory {
    fun otakudesu(
        ...
        bloggerExtractor: AniLabBloggerExtractor = AniLabBloggerExtractor(),
        fileDonExtractor: AniLabFileDonExtractor = AniLabFileDonExtractor(),
        vidhideExtractor: AniLabVidhideExtractor = AniLabVidhideExtractor(),
        streamwishFilelionsExtractor: AniLabStreamwishFilelionsExtractor = AniLabStreamwishFilelionsExtractor(),
        userVideoFamilyExtractor: AniLabUserVideoFamilyExtractor = AniLabUserVideoFamilyExtractor(),
        legacyHostFamilyExtractor: AniLabLegacyHostFamilyExtractor = AniLabLegacyHostFamilyExtractor(),
        ...
        extractors = listOf(
            ...
            fileDonExtractor,
            vidhideExtractor,
            streamwishFilelionsExtractor,
            userVideoFamilyExtractor,
            legacyHostFamilyExtractor,
